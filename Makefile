...
# TextureFileLoader.o
# SimTaDynFile.o
OBJ_GUI        = DialogException.o Redirection.o SimTaDynWindow.o SimTaDynMapExplorer.o TextEditor.o ForthEditor.o
OBJ_GUI       += ForthInspector.o DrawingArea.o
OBJ_GUI       += MVP.o ForthEditorWindow.o MapEditorWindow.o
