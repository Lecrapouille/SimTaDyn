...
public:
  ...
  GLBlockBuffer<int, 2ull> block1;
  // A vertex Buffer block of data
  GLVertexBlockBuffer<int, 2ull> block2;
  // An index Buffer block of data
  GLIndexBlockBuffer<int, 2ull> block3;
  GLIndexCollection<int, 2ull> vbo1;
  GLVertexCollection<int, 2ull> vbo2;
};
...
void GLBufferTests::testDummy()
{
  ...
  CPPUNIT_ASSERT_EQUAL(true, 0ul == win->block1.getID());
  ...
  CPPUNIT_ASSERT_EQUAL(true, 0ul == win->block2.getID());
  ...
  CPPUNIT_ASSERT_EQUAL(true, 0ul == win->block3.getID());
  ...
  // Empty win->block
  CPPUNIT_ASSERT_EQUAL(4ul, win->block1.size());
  size_t i = Block<int, 2ull>::E;
  while (i--)
    {
      CPPUNIT_ASSERT_EQUAL(0ul, win->block1.m_occupied[i]);
    }
  CPPUNIT_ASSERT_EQUAL(0ul, win->block1.occupation());

  // No pending data
  CPPUNIT_ASSERT_EQUAL(INITIAL_INDEX, win->block1.m_pending_start);
  CPPUNIT_ASSERT_EQUAL(INITIAL_INDEX, win->block1.m_pending_end);
  size_t pos_start = 40ul;
  size_t pos_end = 41ull;
  CPPUNIT_ASSERT_EQUAL(false, win->block1.hasPendingData());
  win->block1.getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(false, win->block1.needUpdate());

  // Dummy Set
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo1.used());
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo1.blocks());
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo1.remaining());
  CPPUNIT_ASSERT_EQUAL(true, win->vbo1.empty());
  CPPUNIT_ASSERT_EQUAL(true, win->vbo1.full());
  CPPUNIT_ASSERT_EQUAL(true, win->vbo1.outofbound(0ul));
  CPPUNIT_ASSERT_THROW(win->vbo1.occupied(0ul), std::out_of_range);
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo1.index());
  CPPUNIT_ASSERT_THROW(win->vbo1.get(0ul), std::out_of_range);

  // Dummy Set
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo2.used());
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo2.blocks());
  CPPUNIT_ASSERT_EQUAL(true, nullptr != win->vbo2.block(0));
  CPPUNIT_ASSERT_EQUAL(4ul, win->vbo2.remaining());
  CPPUNIT_ASSERT_EQUAL(true, win->vbo2.empty());
  CPPUNIT_ASSERT_EQUAL(false, win->vbo2.full());
  CPPUNIT_ASSERT_EQUAL(true, win->vbo2.outofbound(0ul));
  CPPUNIT_ASSERT_THROW(win->vbo2.occupied(0ul), std::out_of_range);
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo2.index());
  CPPUNIT_ASSERT_THROW(win->vbo2.get(0ul), std::out_of_range);
  ...
  CPPUNIT_ASSERT_EQUAL(0ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, b->m_pending_start);
  CPPUNIT_ASSERT_EQUAL(0ul, b->m_pending_end);
...
void GLBufferTests::testPendingData()
{
  ...
  win->block1.getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(40ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(41ul, pos_end);
  ...
  win->block1.getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(40ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(42ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(true, win->block1.needUpdate());
  ...
  CPPUNIT_ASSERT_EQUAL(true, win->block1.hasPendingData());
  win->block1.getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(2ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(44ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(true, win->block1.needUpdate());
}
...
void GLBufferTests::testInsert()
{
  ...
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo1.used());
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo1.blocks());
  CPPUNIT_ASSERT_EQUAL(3ul, win->vbo1.remaining());
  CPPUNIT_ASSERT_EQUAL(true, b->hasPendingData());
  b->getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_end);
  ...
  win->vbo1.append(42);
  CPPUNIT_ASSERT_EQUAL(2ul, win->vbo1.used());
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo1.blocks());
  CPPUNIT_ASSERT_EQUAL(2ul, win->vbo1.remaining());
  CPPUNIT_ASSERT_EQUAL(true, b->hasPendingData());
  b->getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(1ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, b->m_pending_start);
  CPPUNIT_ASSERT_EQUAL(1ul, b->m_pending_end);
  CPPUNIT_ASSERT_EQUAL(true, b->needUpdate());

  win->vbo1.append(43);
  CPPUNIT_ASSERT_EQUAL(3ul, win->vbo1.used());
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo1.blocks());
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo1.remaining());
  CPPUNIT_ASSERT_EQUAL(true, b->hasPendingData());
  b->getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(2ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, b->m_pending_start);
  CPPUNIT_ASSERT_EQUAL(2ul, b->m_pending_end);
  CPPUNIT_ASSERT_EQUAL(true, b->needUpdate());

  win->vbo1.append(44);
  CPPUNIT_ASSERT_EQUAL(4ul, win->vbo1.used());
  CPPUNIT_ASSERT_EQUAL(1ul, win->vbo1.blocks());
  CPPUNIT_ASSERT_EQUAL(0ul, win->vbo1.remaining());
  CPPUNIT_ASSERT_EQUAL(true, b->hasPendingData());
  b->getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(3ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(0ul, b->m_pending_start);
  CPPUNIT_ASSERT_EQUAL(3ul, b->m_pending_end);
  CPPUNIT_ASSERT_EQUAL(true, b->needUpdate());
  ...
  CPPUNIT_ASSERT_EQUAL(true, b->hasPendingData());
  b->getPendingData(pos_start, pos_end);
  CPPUNIT_ASSERT_EQUAL(3ul, pos_start);
  CPPUNIT_ASSERT_EQUAL(3ul, pos_end);
  CPPUNIT_ASSERT_EQUAL(3ul, b->m_pending_start);
  CPPUNIT_ASSERT_EQUAL(3ul, b->m_pending_end);
  CPPUNIT_ASSERT_EQUAL(true, b->needUpdate());

  win->vbo1.append(46);
  CPPUNIT_ASSERT_EQUAL(5ul, win->vbo1.used());
  CPPUNIT_ASSERT_EQUAL(2ul, win->vbo1.blocks());
  CPPUNIT_ASSERT_EQUAL(3ul, win->vbo1.remaining());
  b = win->vbo1.block(0);
