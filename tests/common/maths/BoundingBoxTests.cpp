...
{
  CPPUNIT_ASSERT_EQUAL(6ul * sizeof (float), sizeof (AABB3f));
  CPPUNIT_ASSERT_EQUAL(6ul * sizeof (int32_t), sizeof (AABB3i));
  CPPUNIT_ASSERT_EQUAL(6ul * sizeof (double), sizeof (AABB3g));
